...
Next, Next, we examine whether this preference for the confounded toy varies across different age groups. Age is treated here in coarse bins (e.g., 24–27 months, 28–30 months, etc.) to help spot nonlinear trends that might be hard to detect in regression.
